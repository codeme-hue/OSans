    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder messageViewHolder, final int position)
    {
        ...
        usersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.hasChild("image"))
                {
                    ...
                    Picasso.get().load(receiverImage).placeholder(R.drawable.online).into(messageViewHolder.receiverProfileImage);
                }
            }
        ...
        if (fromMessageType.equals("text"))
        {
            ...
            if (fromUserID.equals(messageSenderId)) {
                ...
                Picasso.get().load("https://firebasestorage.googleapis.com/v0/b/osans-c41eb.appspot.com/o/Image%20Files%2FDocument-Blank-icon.png?alt=media&token=c50c4c06-e201-4807-b46e-3e183f2c02be")
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if (i == 0) {
                                    ...
                                    deleteSentMessageForEveryone(position, messageViewHolder);
